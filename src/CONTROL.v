...
module CONTROL(
    ...
    output reg [1:0] UseHILO_ctrl,            // SRC = HI.LO
    output reg WriteHILO_ctrl            // DEST = HILO
    );
    ...
    UseHILO_ctrl = 2'b00;            // Uses the HILO Register e.g. MFLO/MFHI 
    WriteHILO_ctrl = 1'b0;            // Defines the HILO register 
    case (Opcode)
